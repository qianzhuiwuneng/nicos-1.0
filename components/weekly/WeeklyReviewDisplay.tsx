      ...
      {prompts.map((p) => {
        ...
        return (
          ...
          >
            ...
            <div
              className={`weekly-review-display__body prose prose-sm mt-2.5 max-w-none text-[13px] font-normal leading-[1.78] tracking-[-0.006em] text-[var(--foreground)] sm:text-[13.5px] sm:leading-[1.82] ${
